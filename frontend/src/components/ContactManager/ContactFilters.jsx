...
const ContactFilters = ({
  ...
  customStatuses, sectors, winners = [], total, showImportModal, setShowImportModal,
      ...
      <div style={{
        ...
        <div style={{ flexShrink: 0, marginRight: "10px" }}>
          <h2 style={{ fontSize: "1.1rem", fontWeight: "900", color: "#1e293b", margin: 0, display: "flex", alignItems: "center", gap: "10px" }}>
            {deleted ? "Deleted Leads" : "Leads"} <span style={{ fontSize: "0.75rem", background: "#f1f5f9", padding: "2px 8px", borderRadius: "20px", color: "#64748b" }}>{total.toLocaleString()}</span>
          </h2>
        </div>
